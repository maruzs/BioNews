...
# Se asume que usaras python-dotenv para cargar las credenciales del .env
    ...
    def get_legal_data(self):
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                # Esperar a que cargue la pagina post-login
                ...
                with page.expect_response(self.url_api) as response_info:
                    # Segun tu investigacion, solo hay que darle al boton Buscar
    ...
    def _parse_json_data(self, data):
        ...
        for item in data:
            try:
                ...
                link = f"https://pertinencia.sea.gob.cl/proceso/detalle/{item.get('correlativeId')}"
