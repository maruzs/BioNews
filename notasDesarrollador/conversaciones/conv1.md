Ahi si funciona!!
No quiero que cambies nada, quiero que conversemos y crees un archivo llamado microservicios.md donde se guarde lo que escribas o consideres importante.
De este proyecto aun me faltan hacer algunas pequenas cosas, como lo es hacer crawling de las fichas de los documentos que se marquen como favoritos y que se informe cuando hubo cambios, mejorar el home, mejorar el sistema de login y registro, implementar medios de pago ya que es un futuro SaaS, que se envien correos como newsletters, confirmacion o recuperacion de cuenta, una app android y iOS, etc.
Ademas en la universidad estamos aprendiendo sobre CICD, microservicios, etc. y estoy tratando de crear mi propio cluster con laptops viejas que hagan de servidor. Proximamente comprare un dominio para mis diversas web/SaaS.

Considerando todo esto y con lo que quiero implementar a futuro y lo que tengo ahora, que cosas convertirias a microservicios del proyecto actual (y aparte lo que al implementar despues tambien deberia ser microservicios)
Deberia migrar la bd de SQLite a otra?
Que otras mejoras se te ocurre que puedo hacer a nivel de arquitectura? Deberia hacer mas bases de datos en vez de una sola con muchas tablas?
